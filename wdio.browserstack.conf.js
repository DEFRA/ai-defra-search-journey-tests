...
export const config = {
  ...
  baseUrl: `https://ai-defra-search-journey-tests.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `ai-defra-search-journey-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `ai-defra-search-journey-tests-${process.env.ENVIRONMENT}`
        },
